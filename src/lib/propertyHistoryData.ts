...
const D1History: PropertyHistoryData = {
  ...
  historicalFacts: [
    ...
    { year: '2006', title: 'DY Patil Stadium Opens', description: 'The iconic DY Patil Stadium in Nerul, just 3km from Sanpada, became a premier sports venue hosting IPL cricket and putting Navi Mumbai on the global map.', category: 'culture' },
  ],
...
const D2History: PropertyHistoryData = {
  ...
  historicalFacts: [
    ...
    { year: '1857', title: 'Revolt Skirmishes', description: 'During the 1857 uprising, rebel forces used the dense sugarcane fields of the trans-Yamuna plains as cover, with skirmishes recorded near modern-day Noida.', category: 'event' },
    { year: '2014', title: 'Film City Announced', description: 'The UP government announced a Film City project near Sector 96, positioning Noida as a rival to Mumbai\'s Bollywood production infrastructure.', category: 'culture' },
  ],
...
const D3History: PropertyHistoryData = {
  ...
  historicalFacts: [
    ...
    { year: '1857', title: 'Rebellion Route', description: 'Rebel sepoys from Meerut marched through these plains en route to Delhi during the 1857 uprising, using village wells and serais for rest.', category: 'event' },
    { year: '2024', title: 'Metro Phase IV Extension', description: 'Delhi Metro\'s Phase IV extension connected the peri-Delhi belt to Dwarka and central Delhi, reducing commute times to under 45 minutes.', category: 'infrastructure' },
  ],
...
const D4History: PropertyHistoryData = {
  ...
  historicalFacts: [
    ...
    { year: '1576', title: 'Mughal Supply Corridor', description: 'After the Battle of Haldighati, Mughal forces used these arid plains as military supply routes, with camel caravans crossing the corridor between Delhi and Gujarat.', category: 'event' },
    { year: '2024', title: 'Solar-Powered Industrial Zone', description: 'The DMIC node became India\'s first industrial township with 100% renewable energy integration, with solar farms spanning 500 acres alongside the corridor.', category: 'development' },
  ],
...
const D5History: PropertyHistoryData = {
  ...
  historicalFacts: [
    ...
    { year: '1664', title: 'Shivaji\'s Surat Raids', description: 'Maratha king Shivaji raided Surat twice, targeting Mughal treasury ships — the raids reshaped the city\'s defenses and trade routes for a century.', category: 'event' },
    { year: '2006', title: 'Textile Export Capital', description: 'Surat surpassed Ahmedabad as India\'s largest synthetic textile producer, with the industry clustering in manufacturing zones surrounding Varachha.', category: 'culture' },
  ],
...
const D6History: PropertyHistoryData = {
  ...
  historicalFacts: [
    ...
    { year: '1902', title: 'Kalka-Shimla Railway', description: 'The UNESCO World Heritage Kalka-Shimla narrow-gauge railway begins at Kalka, just 12km from Panchkula, connecting the plains to the former British summer capital.', category: 'landmark' },
    { year: '2022', title: 'Wellness Tourism Hub', description: 'Panchkula\'s Shivalik foothill setting attracted premium wellness resorts and Ayurveda retreats, creating a micro-economy blending healthcare with hospitality.', category: 'culture' },
  ],
...
const D7History: PropertyHistoryData = {
  ...
  historicalFacts: [
    ...
    { year: '1737', title: 'Maratha Fort at Thane', description: 'The Marathas wrested control of Thane from the Portuguese, establishing a fort that commanded the crucial overland route between Bombay and the Deccan.', category: 'landmark' },
    { year: '2014', title: 'City of Lakes Branding', description: 'Thane\'s rebranding as the "City of Lakes" — with 35 natural lakes within city limits — transformed its image from dormitory town to lifestyle destination.', category: 'culture' },
  ],
...
const D8History: PropertyHistoryData = {
  ...
  historicalFacts: [
    ...
    { year: '1663', title: 'Dutch Conquest of Cochin', description: 'The Dutch East India Company captured Fort Cochin from the Portuguese, establishing trade dominance over Kerala\'s spice coast for the next 130 years.', category: 'event' },
    { year: '2020', title: 'SmartCity Kochi Campus', description: 'The SmartCity Kochi campus in Kakkanad — a joint India-Dubai venture — added 6 million sqft of IT space, attracting global technology firms to the corridor.', category: 'development' },
  ],
...
const D9History: PropertyHistoryData = {
  ...
  historicalFacts: [
    ...
    { year: '1768', title: 'French-British Rivalry', description: 'Visakhapatnam changed hands between French and British forces during the Carnatic Wars, with its harbor recognized as strategically vital by both empires.', category: 'event' },
    { year: '2020', title: 'Executive Capital Status', description: 'Andhra Pradesh designated Visakhapatnam as the state\'s executive capital, triggering a surge in infrastructure investment and land values across the port city.', category: 'development' },
  ],
...
const D10History: PropertyHistoryData = {
  ...
  historicalFacts: [
    ...
    { year: '1854', title: 'Great Eastern Road', description: 'The British constructed the Nagpur-Raipur trunk road, opening the Chhattisgarh plains to modern commerce and connecting the region to central India\'s rail network.', category: 'infrastructure' },
    { year: '2019', title: 'IIT & AIIMS Campus', description: 'IIT Bhilai and AIIMS Raipur established campuses in Naya Raipur, creating institutional anchors that attract students, faculty, and healthcare professionals from across India.', category: 'development' },
  ],
...
const D11History: PropertyHistoryData = {
  ...
  historicalFacts: [
    ...
    { year: '1759', title: 'British Seize Surat Castle', description: 'The East India Company seized Surat Castle from the Mughals, redirecting trade power to Bombay — Magdalla\'s fortunes declined as shipping routes shifted south.', category: 'event' },
    { year: '2023', title: 'Hazira Port Expansion', description: 'The Hazira port and LNG terminal expansion near Magdalla boosted industrial activity along Surat\'s southern coast, driving demand for supporting residential infrastructure.', category: 'development' },
  ],
...
const D12History: PropertyHistoryData = {
  ...
  historicalFacts: [
    ...
    { year: '1540', title: 'Grand Trunk Road Legacy', description: 'Sher Shah Suri\'s Grand Trunk Road passed through the trans-Yamuna region, connecting Delhi to Bengal — the area\'s first major infrastructure artery.', category: 'landmark' },
    { year: '2018', title: 'Botanical Garden Metro Hub', description: 'The Botanical Garden interchange station connecting Blue and Magenta metro lines made adjacent Sector 15A one of Noida\'s best dual-line connected addresses.', category: 'infrastructure' },
  ],
